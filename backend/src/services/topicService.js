...
const DEFAULT_TOPICS = [
  ...
  // Standard 8 Tamil Chapter 1 Topics (ch-tam8-1)
  {
    id: 'topic-tam8-1-1',
    chapterId: 'ch-tam8-1',
    title: 'தமிழ்மொழி வாழ்த்து & மகாகவி பாரதியார்',
    description: 'பாரதியாரின் கவிதை நயம், மொழிப் பற்று, இதழியல் பணிகள், மற்றும் ஆசிரியர் குறிப்பு.',
    orderNumber: 1,
    isActive: true,
  },
  {
    id: 'topic-tam8-1-2',
    chapterId: 'ch-tam8-1',
    title: 'தமிழ்மொழி மரபு & தொல்காப்பியர்',
    description: 'ஐம்பூதக் கொள்கை, தொல்காப்பிய அதிகாரங்கள், விலங்குகளின் இளமைப் பெயர்கள், மற்றும் ஒலி மரபுகள்.',
    orderNumber: 2,
    isActive: true,
  },
  {
    ...
    description: 'ஓவிய எழுத்து, வட்டெழுத்து, வீரமாமுனிவர் மற்றும் தந்தை பெரியாரின் எழுத்துச் சீர்திருத்தங்கள்.',
    orderNumber: 3,
    isActive: true,
  },
  {
    ...
    description: 'உயிர், மெய், மற்றும் ஆய்த எழுத்துகளின் இடப்பிறப்பு மற்றும் முயற்சிப் பிறப்பு இலக்கணம்.',
    orderNumber: 4,
    isActive: true,
  },

  // Standard 8 English Chapter 1 Topics (ch-eng8-1)
  {
    id: 'topic-eng8-1-1',
    chapterId: 'ch-eng8-1',
    title: 'Reading Comprehension: The Nose-Jewel',
    description: 'C. Rajagopalachari classic story of Ramayya, the sparrows, and the lost diamond stud.',
    orderNumber: 1,
    isActive: true,
  },
  {
    id: 'topic-eng8-1-2',
    chapterId: 'ch-eng8-1',
    title: 'Themes & Characters: Greed vs Contentment',
    description: 'Moral dilemmas, psychological fear of dishonesty, and ethical living.',
    orderNumber: 2,
    isActive: true,
  },
  {
    id: 'topic-eng8-1-3',
    chapterId: 'ch-eng8-1',
    title: 'Grammar: Parts of Speech & Prepositions',
    description: 'Identification of parts of speech, correct usage of prepositions (behind, among, between).',
    orderNumber: 3,
    isActive: true,
  },
  {
    id: 'topic-eng8-1-4',
    chapterId: 'ch-eng8-1',
    title: 'Vocabulary: Homophones & Prefix/Suffix',
    description: 'Homophones pairs, contextual word meaning, and vocabulary enrichment.',
    orderNumber: 4,
    isActive: true,
  },

  // Standard 8 Mathematics Chapter 1 Topics (ch-math8-1)
  {
    id: 'topic-math8-1-1',
    chapterId: 'ch-math8-1',
    title: 'Rational Numbers & Standard Form',
    description: 'Definition of rational numbers (p/q, q != 0), standard form, and number line representation.',
    orderNumber: 1,
    isActive: true,
  },
  {
    id: 'topic-math8-1-2',
    chapterId: 'ch-math8-1',
    title: 'Arithmetic Operations on Rational Numbers',
    description: 'Addition, subtraction, multiplication, and division of rational numbers with unlike denominators.',
    orderNumber: 2,
    isActive: true,
  },
  {
    id: 'topic-math8-1-3',
    chapterId: 'ch-math8-1',
    title: 'Rational Numbers Between Two Rationals',
    description: 'Finding rational numbers using the mean formula (a+b)/2 and equivalent fractions.',
    orderNumber: 3,
    isActive: true,
  },
  {
    id: 'topic-math8-1-4',
    chapterId: 'ch-math8-1',
    title: 'Properties of Rational Numbers & Reciprocal',
    description: 'Closure, commutative, associative, distributive, additive/multiplicative identity and inverse.',
    orderNumber: 4,
    isActive: true,
  },

  // Standard 8 Science Chapter 1 Topics (ch-sci8-1)
  {
    id: 'topic-sci8-1-1',
    chapterId: 'ch-sci8-1',
    title: 'Base SI Quantities & Temperature Scales',
    description: 'The 7 base SI physical units, temperature scales (Celsius, Fahrenheit, Kelvin), and conversions.',
    orderNumber: 1,
    isActive: true,
  },
  {
    id: 'topic-sci8-1-2',
    chapterId: 'ch-sci8-1',
    title: 'Electric Current & Amount of Substance',
    description: 'Ampere, Ammeter connection, Mole concept, and Avogadro constant (6.023 x 10^23).',
    orderNumber: 2,
    isActive: true,
  },
  {
    id: 'topic-sci8-1-3',
    chapterId: 'ch-sci8-1',
    title: 'Luminous Intensity & Photometers',
    description: 'Candela (cd), luminous flux, photometer instruments, and plane/solid angles.',
    orderNumber: 3,
    isActive: true,
  },
  {
    id: 'topic-sci8-1-4',
    chapterId: 'ch-sci8-1',
    title: 'Quartz & Atomic Clocks & Accuracy',
    description: 'Piezoelectric quartz clocks, Cesium-133 atomic clocks, precision, and GPS time standards.',
    orderNumber: 4,
    isActive: true,
  },

  // Standard 8 Social Science Chapter 1 Topics (ch-soc8-1)
  {
    id: 'topic-soc8-1-1',
    chapterId: 'ch-soc8-1',
    title: 'Sea Route to India & Portuguese Rule',
    description: 'Fall of Constantinople (1453), Vasco da Gama (1498), Almeida Blue Water Policy, Albuquerque (Goa 1510).',
    orderNumber: 1,
    isActive: true,
  },
  {
    id: 'topic-soc8-1-2',
    chapterId: 'ch-soc8-1',
    title: 'Dutch & British East India Companies',
    description: 'British Royal Charter 1600, Sir Thomas Roe Jahangir visit, Francis Day founding Fort St. George Madras (1639).',
    orderNumber: 2,
    isActive: true,
  },
  {
    id: 'topic-soc8-1-3',
    chapterId: 'ch-soc8-1',
    title: 'Danish & French Settlements in India',
    description: 'Danish Fort Dansborg at Tranquebar (1620), Francois Martin founding Pondicherry (1673).',
    orderNumber: 3,
    isActive: true,
  },
  {
    id: 'topic-soc8-1-4',
    chapterId: 'ch-soc8-1',
    title: 'European Trade Rivalry & Historical Battles',
    description: 'Anglo-French Carnatic wars, Battle of Plassey (1757), Siraj-ud-Daulah, and British supremacy.',
    orderNumber: 4,
    isActive: true,
  },
];
