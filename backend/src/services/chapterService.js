...
const DEFAULT_CHAPTERS = [
  ...
  // Standard 8 Subject Chapters
  {
    ...
    xpReward: 400,
    coinReward: 100,
    badgeName: 'Tamil Scholar 8',
    isLocked: false,
    isActive: true,
    displayOrder: 1,
    subject: { id: 'subj-tamil', name: 'Tamil', code: 'TAMIL', icon: '📚' },
    standard: { id: 'grade-8', name: '8', displayName: '8th Standard' },
  },
  {
    id: 'ch-eng8-1',
    standardId: 'grade-8',
